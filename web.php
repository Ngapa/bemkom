					...
					<div class="container">
						<div class="card">
							<div class="card-body">
								...
								<div class="card">
								<center><img src="assets/img/webprog.jpg" class="img-thumbnail" width="400px"></center>
								<div class="card-subtitle text-justify">
									<p>
										<h1>Tunggu selanjutnya.</h1>
									</p>
									<p>
										Unit Kegiatan Mahasiswa Web Programming atau biasa disebut dengan UKM Web Programming, merupakan organisasi baru yang dibentuk pada tahun 2019.
									</p>	
