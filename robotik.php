					...
					<div class="container">
						<div class="card">
							<div class="card-body">
								...
								<div class="card">
								<center><img src="assets/img/robotika.jpg" class="img-thumbnail" width=""></center>
								<div class="card-subtitle text-justify">
									<p>
										<h1>Sejarah umum</h1>
									</p>
									<p>
										Unit Kegiatan Mahasiswa Robotika atau biasa disebut dengan UKM Robotika, merupakan organisasi baru yang dibentuk pada tahun 2019. UKM Robotika ini merupakan sebuah wadah kegiatan bagi mahasiswa STMIK Komputama Majenang yang memiliki minat dalam bidang konstruksi, operasi, pembuatan, dan aplikasi robot. Robotika meliputi berbagai macam cabang ilmu, antara lain elektronika, mesin, mekanika, aerodinamika dan perangkat lunak komputer. Dengan adanya UKM Robotika ini, diharapkan mahasiswa STMIK Komputama Majenang dapat meningkatkan pengetahuan, wawasan, dan keterampilan tentang perkembangan teknologi robotika.		
									</p>
									<p>
										Visi :
									</p>
									<p>
										Menjadikan UKM Robotika kreatif, inovatif serta sebagai wadah berkembangnya kreativitas dalam bidang robotika yang dapat menghasilkan prestasi bagi almamater.
									</p>
									<p>
										Misi :
									</p>
									<p>
										Mewadahi mahasiswa yang berminat dalam bidang robotika, serta menghasilkan inovasi untuk pengembangan pada bidang robotika di STMIK Komputama Majenang.
									</p>
